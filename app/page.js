        ...
        <div style={S.rp}>
          ...
          {rTab === "clinicalContext" && <div style={{ display: "flex", flexDirection: "column", flex: 1, minHeight: 0 }}>
            <div style={{ ...S.rh, background: P.chatHeader, borderColor: P.chatHeaderBorder }}>
              ...
              <button onClick={genClinicalContext} style={{ ...S.cb("s"), color: P.chatTitleColor }}>🩺 Generar ahora</button>
            </div>
            <div style={{ ...S.rc, background: P.chatPanelBg }}>
              {clinicalContext
                ? <div dangerouslySetInnerHTML={{ __html: clinicalContext }} />
                : <div style={S.ph}><div style={S.phI}>🩺</div><div style={{ ...S.phT, color: P.chatTitleColor }}>Contexto clínico bajo demanda</div><div style={S.phD}>Cuando hayas rellenado los campos, pulsa "🩺 Generar ahora" para crearlo.</div><button onClick={genClinicalContext} style={{ ...S.aBtn, background: "linear-gradient(135deg,#0ea5e9,#0284c7)" }}>🩺 Generar contexto clínico</button></div>}
            </div>
          </div>}
